...
(function (TSOS) {
    var ProcessControlBlock = (function () {
        function ProcessControlBlock(pid, pc, acc, xreg, yreg, zflag, ir, base, limit, state, priority, ondisk, writtento) {
            ...
            if (ondisk === void 0) { ondisk = null; }
            if (writtento === void 0) { writtento = null; }
            this.pid = pid;
            this.pc = pc;
            this.acc = acc;
            this.xreg = xreg;
